Para empezar tenemos un apartado de reglas en el boton "Reglas" el cual muestra de manera directa lo que se puede y no se puede hacer, ademas de como se van a hacer las encriptaciones
